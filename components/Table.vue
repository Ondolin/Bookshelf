    ...
    <div class="container mx-auto">
      ...
      <div
        ...
        <div v-for="book in filteredBooks"
          ...
          <img src="icon-edit.png" class="absolute right-0 top-0 w-6 h-6 m-3 ml-5 invert-effect" @click="editBook(book)">
          ...
          <div class="mr-4">
            ...
            <div class="mt-2"><span class="select-none">ISBN: </span>{{book.isbn13}}</div>
          </div>
  ...
  export default {
    ...
    computed: {
      ...
        mapGetters(['books']),
      filteredBooks () {
        return this.books.filter(a => a.title.toUpperCase().includes(this.searchTerm.toUpperCase()) || a.isbn13.toUpperCase().includes(this.searchTerm.toUpperCase()) || a.authors.toUpperCase().includes(this.searchTerm.toUpperCase()))
      }
    }
    ,
  }
